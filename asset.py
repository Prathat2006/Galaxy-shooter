...
BULLETSMART = Fore.YELLOW + "|" + Style.RESET_ALL
print(BULLET)
...
# FORMATION_HEIGHT =2   # Default number of enemy rows(7 is best for experience)
FORMATION_WIDTH = 20 # Default number of enemy columns(20 is best for experience)
# FORMATION_WIDTH = 2 # Default number of enemy columns(20 is best for experience)
E1= [
    "/|\\",
    "-O-",
    "\\|/"
